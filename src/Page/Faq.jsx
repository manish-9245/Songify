    ...
    <div className="bg-[#2d1b69] pl-10 pr-4 max-md:pl-4 overflow-y-hidden pb-24 h-screen">
      <div className=" text-white ">
        <div className=" rounded-lg mt-7">
          ...
          >
            <div className="px-5 py-4 bg-[#1b103f] rounded-b-lg">
              Songify is a free open source music streaming/downloading platform to stream and download songs
              without any paywall.
              </div>
          </TECollapse>
        </div>
        ...
        <div className=" rounded-lg mt-7">
          <h2 className="mb-0" id="headingTwo">
            <button
              ...
              aria-controls="collapseOne"
            >
              Songify api and where does it store data?
              <span
                className={`${
                  activeElement === "element2"
                    ? `rotate-[-180deg] -mr-1`
          ...
          >
            <div className="px-5 py-4 bg-[#1b103f] rounded-b-lg">
              Songify uses an unofficial jio saavan scrapper to list and stream songs <br/>
        ...
        <div className=" rounded-lg mt-7">
          ...
          >
            <div className="px-5 py-4 bg-[#1b103f] rounded-b-lg ">
                Songify is a hobby project by <a href="https://www.linkedin.com/in/manishtiwari13/"><strong>Manish Tiwari</strong></a>, a Software Engineer based in India 
              </div>
          </TECollapse>
        </div>
